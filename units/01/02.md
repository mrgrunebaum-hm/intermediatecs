...
We will be using [Scala 2](https://www.scala-lang.org/). Make sure your computer environment is properly set up to compile and run Scala programs.
  ...
  1. Check that your computer has Java installed by running `java --version` in your terminal. If you see something like "java 15.0.1 2020-10-20" as the first line, then you have Java installed and can move on to the next step. If you see something to the effect of "command not found", then you need to download the correct version of Java to your computer from [this link for Mac OS X](https://www.oracle.com/java/technologies/downloads/#java11-mac) or [this link for Windows](https://www.oracle.com/java/technologies/downloads/#java11-windows).
